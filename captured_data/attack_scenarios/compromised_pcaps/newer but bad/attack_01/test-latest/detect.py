...
class Detector:
    def __init__(self, policy_file, addr_map_file):
        ...
        self.ip_to_vlan = net.get("ip_to_vlan_map", {})
        ...
        self.polling_resync_grace  = int(self.polling_rules.get('resync_grace', 1)) 
        self.polling_tempo_epsilon = float(self.polling_rules.get('tempo_epsilon', 0.02))

        self.polling_preferred     = self.polling_rules.get('preferred_sequence')
    ...
    def _check_polling_sequence(self, e):
        ...
        interval = active['inter_request_interval']
