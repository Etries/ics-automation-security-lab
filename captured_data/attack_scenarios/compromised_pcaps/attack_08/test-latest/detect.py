...
class Detector:
    ...
    # ---- NEW: safer polling sequence (reduced false positives)
    def _check_polling_sequence(self, e):
        ...
        def set_state(seq_name, idx):
            self.state.polling_state[key] = {
                ...
                'resyncs': 0,       # how many mismatches handled without alert
            }
        ...
        if not st:
            ...
            # non-strict: align to any matching position without alert
        ...
        if current_func == expected_func:
            # tempo check after warm-up; allow epsilon slack
            if st['steps'] >= 1:
        ...
        # Order mismatch → allow limited silent resyncs
        ...
        # Exceeded grace → alert and resync for continuity
